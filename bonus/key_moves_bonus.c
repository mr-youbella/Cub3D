...
static void key_w(t_data *data)
{
	...
	if (!is_blocked(data, data->donneee->new_pos_x + 0.15, data->pos_y) && !is_blocked(data, data->donneee->new_pos_x - 0.15, data->pos_y) && !is_blocked(data, data->donneee->new_pos_x, data->pos_y + 0.15) && !is_blocked(data, data->donneee->new_pos_x, data->pos_y - 0.15))
		data->pos_x = data->donneee->new_pos_x;
	if (!is_blocked(data, data->pos_x, data->donneee->new_pos_y + 0.15) && !is_blocked(data, data->pos_x, data->donneee->new_pos_y - 0.15) && !is_blocked(data, data->pos_x + 0.15, data->donneee->new_pos_y) && !is_blocked(data, data->pos_x - 0.15, data->donneee->new_pos_y))
