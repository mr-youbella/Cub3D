...
void rotate_mouse(void *arg)
{
	...
	if (mlx_is_key_down(data->game->init, MLX_KEY_M))
	{
		...
		if (delta_x > 0)
		{
			...
			data->dir_x = data->dir_x * cos(0.10) - data->dir_y * sin(0.10);
			data->dir_y = old_dir_x * sin(0.10) + data->dir_y * cos(0.10);

			old_plane_x = data->plane_x;
			data->plane_x = data->plane_x * cos(0.10) - data->plane_y * sin(0.10);
			data->plane_y = old_plane_x * sin(0.10) + data->plane_y * cos(0.10);
		}
		else if (delta_x < 0)
		{
			old_dir_x = data->dir_x;
