...
void check_key_moves(void *arg)
{
	...
	if (mlx_is_key_down(data->game->init, MLX_KEY_W))
	{
		...
		if (data->map_data->map[(int)(data->pos_y + 0.1)][(int)(new_pos_x + 0.1)] != '1' &&
			data->map_data->map[(int)(data->pos_y - 0.1)][(int)(new_pos_x - 0.1)] != '1')
			data->pos_x = new_pos_x;

		if (data->map_data->map[(int)(new_pos_y + 0.1)][(int)(data->pos_x + 0.1)] != '1' &&
			data->map_data->map[(int)(new_pos_y - 0.1)][(int)(data->pos_x - 0.1)] != '1')
